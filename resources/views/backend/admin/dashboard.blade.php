    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="bg-white dark:bg-gray-800 shadow-xl transition-all duration-300 ease-in-out border-r border-gray-200 dark:border-gray-700" 
            ...
            <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="transition-all duration-300" :class="sidebarOpen ? 'visible' : 'invisible w-0'">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400">Dashboard v2.0</p>
                    </div>
                </div>
            </div>
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-200 dark:border-gray-700">
                <div class="flex items-center space-x-3" :class="sidebarOpen ? 'visible' : 'hidden w-0'">
                ...
                <div class="flex items-center justify-between h-full px-6">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative hidden md:block">
                            <input type="text" 
                                   placeholder="Search..." 
                                   class="w-64 pl-10 pr-4 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-colors duration-200">
                            ...
                            <div x-show="open" @click.away="open = false" 
                                ...
                                <div class="max-h-64 overflow-y-auto">
                                    <template x-for="notification in notifications" :key="notification.id">
                                        <div class="p-4 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200">
